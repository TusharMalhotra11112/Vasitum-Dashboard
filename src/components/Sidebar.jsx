    ...
    <div className='sidebar'>
        ...
        <div className="mainMenu">
            ...
            <div className={"sidebarTab"} onClick={()=>{setCurrSide(0)}}>
              ...
              <p className={currSide == 0?"active":""}>DashBoard</p>
            </div>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='sidebarImg'>
              ...
              <p className={currSide==1?" active":""}>Recruitement</p>
            </div>
            ...
            <div className='sidebarTab' onClick={()=>{setCurrSide(2)}}>
              ...
              <p className={currSide==2?" active":""}>Schedule</p>
            </div>
            ...
            <div className='sidebarTab' onClick={()=>{setCurrSide(3)}}>
              ...
              <p className={currSide==3?" active":""}>Employee</p>
            </div>
            ...
            <div className='sidebarTab' onClick={()=>{setCurrSide(4)}}>
              ...
              <p className={currSide==4?" active":""}>Department</p>
            </div>
        </div>
        ...
        <div className="other">
            ...
            <div className='sidebarTab' onClick={()=>{setCurrSide(5)}}>
              ...
              <p className={currSide==5?" active":""}>Support</p>
            </div>
            ...
            <div className='sidebarTab' onClick={()=>{setCurrSide(6)}}>
              ...
              <p className={currSide==6?" active":""}>Settings</p>
            </div>
        </div>
    </div>
  )
